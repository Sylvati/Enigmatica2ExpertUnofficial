...
# Thermal Creative Tank
	...
	[[<industrialforegoing:black_hole_tank>, <minecraft:milk_bucket>, <forge:bucketfilled>.withTag({FluidName: "blood", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "liquiddna", Amount: 1000}), <thermalexpansion:tank>.withTag({Creative: 0 as byte, Level: 0 as byte, RSControl: 0 as byte, Fluid: {FluidName: "bio.ethanol", Amount: 32000}, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "bio.ethanol", Amount: 32000}}), <forge:bucketfilled>.withTag({FluidName: "juice", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "mutagen", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "biomass", Amount: 1000}), <industrialforegoing:black_hole_tank>],
	...
	[<thermalexpansion:tank>.withTag({RSControl: 0 as byte, Creative: 0 as byte, Fluid: {FluidName: "tree_oil", Amount: 32000}, Level: 0 as byte, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "tree_oil", Amount: 32000}}), <contenttweaker:anglesite>, megaDrum, ultCatalyst, <draconicevolution:chaotic_core>, ultCatalyst, megaDrum, <contenttweaker:anglesite>, <thermalexpansion:tank>.withTag({Creative: 0 as byte, Level: 0 as byte, RSControl: 0 as byte, Fluid: {FluidName: "ic2uu_matter", Amount: 32000}, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "ic2uu_matter", Amount: 32000}})],
	...
	[<industrialforegoing:black_hole_tank>, <forge:bucketfilled>.withTag({FluidName: "ender", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "cryotheum", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "petrotheum", Amount: 1000}), <thermalexpansion:tank>.withTag({Creative: 0 as byte, Level: 0 as byte, RSControl: 0 as byte, Fluid: {FluidName: "mana", Amount: 32000}, Lock: 0 as byte})|<thermalexpansion:tank>.withTag({Fluid: {FluidName: "mana", Amount: 32000}}), <forge:bucketfilled>.withTag({FluidName: "refined_fuel", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "mirion", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "neutron", Amount: 1000}), <industrialforegoing:black_hole_tank>]]);
...
# Creative essentia
  ...
  [<ore:ingotThaumium>,  <contenttweaker:benitoite>,  <ore:ingotBrass>,  <thaumicenergistics:blank_knowledge_core>,  <thaumicenergistics:essentia_component_64k>,  <thaumicenergistics:blank_knowledge_core>,  <ore:ingotBrass>,  <contenttweaker:benitoite>, <ore:ingotThaumium>],
  [<ore:ingotThaumium>,  <contenttweaker:benitoite>,  <ore:ingotBrass>,  <thaumicenergistics:essentia_component_64k>,  <appliedenergistics2:material:39>,  <thaumicenergistics:essentia_component_64k>,  <ore:ingotBrass>,  <contenttweaker:benitoite>,  <ore:ingotThaumium>],
  [<ore:ingotThaumium>,  <contenttweaker:benitoite>,  <ore:ingotBrass>,  <thaumicenergistics:blank_knowledge_core>,  <thaumicenergistics:essentia_component_64k>,  <thaumicenergistics:blank_knowledge_core>,  <ore:ingotBrass>,  <contenttweaker:benitoite>,  <ore:ingotThaumium>],
  [<ore:ingotThaumium>,  <contenttweaker:benitoite>,  <thaumcraft:mind>,  <ore:ingotBrass>,  <ore:ingotBrass>,  <ore:ingotBrass>,  <thaumcraft:mind>,  <contenttweaker:benitoite>,  <ore:ingotThaumium>],
  [<ore:ingotThaumium>, <thaumcraft:mechanism_complex>,  <contenttweaker:benitoite>,  <contenttweaker:benitoite>,  <contenttweaker:benitoite>,  <contenttweaker:benitoite>,  <contenttweaker:benitoite>, <thaumcraft:mechanism_complex>,  <ore:ingotThaumium>],
  [<ore:blockVoid>, <ore:ingotThaumium>, <ore:ingotThaumium>, <ore:ingotThaumium>, <ore:ingotThaumium>, <ore:ingotThaumium>, <ore:ingotThaumium>, <ore:ingotThaumium>, <ore:blockVoid>]]);
